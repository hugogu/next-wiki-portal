...
const en: Dict = {
  ...
  'hero.title.a': 'A governed',
  'hero.title.b': 'Agent Runtime',
  'hero.title.c': 'for durable knowledge',
  'hero.sub': 'Turn conversations and sources into durable knowledge: capture evidence, let the runtime organize it through dialogue, publish when it is ready. An AI memory you can run, inspect, and export — self-hosted with a single command, never locked to a single AI vendor.',
  'hero.sub.tail': '',
  'hero.cta.repo': 'GitHub Repo',
  'hero.cta.start': 'Quick Start',
  'hero.term.seeded': '# Seeds itself on first run',
  'hero.term.mcp': 'Agent Runtime online — MCP & Skill tools ready for Claude / Cursor',

  // Features stats
  'stats.1.value': '1 command',
  'stats.1.label': 'docker compose up to launch',
  'stats.2.value': '26 tools',
  'stats.2.label': 'in the built-in MCP tool runtime',
  'stats.3.value': '100%',
  ...
  'f.3.title': 'Governed agent runtime',
  'f.3.desc': 'A built-in MCP-compatible tool provider gives AI 26 read/draft/organize tools over the same permission-checked services as the web UI — with risk policies, admin proposal review, tool evidence, and audit events.',
...
const zh: Dict = {
  ...
  'hero.title.b': 'Agent Runtime',
  'hero.title.c': '沉淀耐久知识',
  'hero.sub': '把对话与素材沉淀为耐久知识：捕获证据、让运行时通过对话完成整理与建设、成熟时发布。一个可运行、可检视、可导出的 AI 长期记忆 —— 一条命令即可自托管，永不锁定于单一 AI 厂商。',
  'hero.sub.tail': '',
  'hero.cta.repo': 'GitHub 仓库',
  'hero.cta.start': '快速开始',
  'hero.term.seeded': '# 首次运行自动完成初始化',
  'hero.term.mcp': 'Agent Runtime online — MCP & Skill 工具已就绪（Claude / Cursor）',

  'stats.1.value': '1 条命令',
  'stats.1.label': 'docker compose up 启动',
  'stats.2.value': '26 个工具',
  'stats.2.label': '内置 MCP 工具运行时',
  'stats.3.value': '100%',
  ...
  'f.3.title': '受治理的 Agent Runtime',
  'f.3.desc': '内置 MCP 兼容工具提供方为 AI 提供 26 个读取/起草/组织工具，运行在与 Web UI 相同的权限受检服务之上 —— 风险策略、管理员提案审查、工具证据与审计事件一应俱全。',
